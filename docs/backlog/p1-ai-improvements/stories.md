# P1 — AI Improvements (10 stories rimanenti)

> **Contesto:** stories rimanenti per migliorare backend AI e frontend UX di Verso.
...
| 6 | Language policy | Esempi concreti in tailor (analyze + tailor) | Basso |
...
```
BACKEND:     5 → 6
FRONTEND:    10 → 11 → 12 → 13 → 14 → 15 → 16 → 17
```

> **Story 17 va per ultima** perché dipende dall'aggiornamento di `ai-prescreen` (backend). Tutte le altre stories frontend sono indipendenti dal backend AI.

---

*Verso Improvements v2 — Specifiche Lovable — 2026-03-08*
