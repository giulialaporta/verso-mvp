      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
          <CardContent className="pt-6">
            ...
            {/* Checkbox T&C obbligatoria per OAuth in signup mode */}
            {isSignUp && (
              <div className="flex items-start gap-2 mb-4">
                <Checkbox
                  ...
                  className="mt-0.5"
                />
                <CheckLabel htmlFor="oauth-terms" className="text-[13px] font-normal leading-snug text-muted-foreground cursor-pointer">
                  Accetto i{" "}
                  <Link to="/termini" target="_blank" className="text-primary underline underline-offset-4 hover:text-primary/80">
                    Termini e Condizioni
                  </Link>{" "}
            ...
            <Button
              ...
              disabled={oauthLoading || (isSignUp && !acceptedTerms)}
