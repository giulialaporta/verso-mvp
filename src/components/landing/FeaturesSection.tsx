...
const rows = [
  ...
  },
  {
    ...
    body: "Per ogni candidatura, Verso calcola il tuo score di compatibilità e ti mostra quali competenze ti mancano — così sai esattamente su cosa lavorare.",
    bullets: ["Score 0–100 per ogni application", "Gap analysis per skill critiche", "Suggerimenti mirati per migliorare"],
    mock: <ScoreMock />,
    reverse: true,
  },
  {
